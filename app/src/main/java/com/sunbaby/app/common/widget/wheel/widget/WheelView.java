 ...
 */
package com.sunbaby.app.common.widget.wheel.widget;
...
import com.sunbaby.app.common.widget.wheel.adapter.BaseWheelAdapter;
import com.sunbaby.app.common.widget.wheel.adapter.SimpleWheelAdapter;
import com.sunbaby.app.common.widget.wheel.common.WheelConstants;
import com.sunbaby.app.common.widget.wheel.common.WheelViewException;
import com.sunbaby.app.common.widget.wheel.graphics.DrawableFactory;
...
public class WheelView<T> extends ListView implements IWheelView<T> {
    ...
    public void setWheelAdapter(BaseWheelAdapter<T> adapter) {
        ...
        mWheelAdapter.setData(mList).setWheelSize(mWheelSize).setLoop(mLoop).setClickable
                (mClickable);
    }
    ...
    private void refreshTextView(int position, int curPosition, View
        ...
        if (curPosition == position) { // 选中
            ...
            float defTextSize = mStyle.textSize != -1 ? mStyle.textSize : WheelConstants
                    .WHEEL_TEXT_SIZE;
            float textSize = mStyle.selectedTextSize != -1 ? mStyle
                    .selectedTextSize : (mStyle.selectedTextZoom != -1 ? (defTextSize * mStyle
                    .selectedTextZoom) :
                    defTextSize);
