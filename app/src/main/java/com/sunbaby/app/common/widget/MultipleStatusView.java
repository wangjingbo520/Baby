...
public class MultipleStatusView extends FrameLayout {
    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        ...
        mViewRes.put(ViewType.TYPE_LOADING, R.layout.activity_loading);
        mViewRes.put(ViewType.TYPE_NETWORK_POOR, R.layout.activity_networkerror);
        mViewRes.put(ViewType.TYPE_EMPTY, R.layout.activity_emptydata);
        mViewRes.put(ViewType.TYPE_ERROR, R.layout.activity_error);
        ...
        if (attrs != null) {
            ...
            if (a != null) {
                mViewRes.put(ViewType.TYPE_LOADING, a.getResourceId(R.styleable.MultipleStatusView_loading, R.layout.activity_loading));
                mViewRes.put(ViewType.TYPE_NETWORK_POOR, a.getResourceId(R.styleable.MultipleStatusView_network_poor, R.layout.activity_networkerror));
                mViewRes.put(ViewType.TYPE_EMPTY, a.getResourceId(R.styleable.MultipleStatusView_empty, R.layout.activity_emptydata));
                mViewRes.put(ViewType.TYPE_ERROR, a.getResourceId(R.styleable.MultipleStatusView_error, R.layout.activity_error));
